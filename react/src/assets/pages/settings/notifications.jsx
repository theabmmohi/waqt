      ...
      <Stack sx={{ alignSelf: "center", width: { xs: "100%", sm: 600 }, gap: 2.5 }}>
        <Stack sx={{ flexDirection: "row", border: "1px solid", borderColor: "divider", borderRadius: 1, p: 2.5, gap: 2.5 }}>
          <Stack sx={{ flex: 1 }}>
            ...
            <Typography variant="body2" color="text.secondary">Includes prayer time reminders (with quick actions to mark as prayed or snooze) and a daily hadith.</Typography>
          </Stack>
